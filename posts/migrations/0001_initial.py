    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_post', models.ImageField(blank=True, null=True, upload_to='posts_img/%Y/%m/%d/')),
                ...
                ('category_post', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='categories.category')),
            ],
        ),
    ]
